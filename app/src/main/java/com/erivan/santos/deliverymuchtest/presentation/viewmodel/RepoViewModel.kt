...
class RepoViewModel(val repository: RepoRepositoryContract) : ViewModel() {
...
//                      Repo(it.name, it.description, it.owner.avatarUrl, it.owner.login)
    ...
    class RepoViewModelFactory(val repository: RepoRepositoryContract) : ViewModelProvider.Factory {
